//--------------------------------------------------------------------------------
// Auto-generated by LiteX (112f78bd) on 2023-11-21 21:06:50
//--------------------------------------------------------------------------------
...
#define CSR_ADC_CONTROL_LDO_EN_OFFSET 0
#define CSR_ADC_CONTROL_LDO_EN_SIZE 1
#define CSR_ADC_CONTROL_PLL_EN_OFFSET 1
#define CSR_ADC_CONTROL_PLL_EN_SIZE 1
...
#define CSR_ADC_STATUS_ADDR (CSR_BASE + 0x4L)
#define CSR_ADC_STATUS_SIZE 1
#define CSR_ADC_STATUS_LDO_PWR_GOOD_OFFSET 0
#define CSR_ADC_STATUS_LDO_PWR_GOOD_SIZE 1
#define CSR_ADC_SPI_CONTROL_ADDR (CSR_BASE + 0x8L)
#define CSR_ADC_SPI_CONTROL_SIZE 1
#define CSR_ADC_SPI_CONTROL_START_OFFSET 0
#define CSR_ADC_SPI_CONTROL_START_SIZE 1
#define CSR_ADC_SPI_CONTROL_LENGTH_OFFSET 8
#define CSR_ADC_SPI_CONTROL_LENGTH_SIZE 8
#define CSR_ADC_SPI_STATUS_ADDR (CSR_BASE + 0xcL)
#define CSR_ADC_SPI_STATUS_SIZE 1
#define CSR_ADC_SPI_STATUS_DONE_OFFSET 0
#define CSR_ADC_SPI_STATUS_DONE_SIZE 1
#define CSR_ADC_SPI_STATUS_MODE_OFFSET 1
#define CSR_ADC_SPI_STATUS_MODE_SIZE 1
#define CSR_ADC_SPI_MOSI_ADDR (CSR_BASE + 0x10L)
#define CSR_ADC_SPI_MOSI_SIZE 1
#define CSR_ADC_SPI_MISO_ADDR (CSR_BASE + 0x14L)
#define CSR_ADC_SPI_MISO_SIZE 1
#define CSR_ADC_SPI_CS_ADDR (CSR_BASE + 0x18L)
#define CSR_ADC_SPI_CS_SIZE 1
#define CSR_ADC_SPI_CS_SEL_OFFSET 0
#define CSR_ADC_SPI_CS_SEL_SIZE 1
#define CSR_ADC_SPI_CS_MODE_OFFSET 16
#define CSR_ADC_SPI_CS_MODE_SIZE 1
#define CSR_ADC_SPI_LOOPBACK_ADDR (CSR_BASE + 0x1cL)
#define CSR_ADC_SPI_LOOPBACK_SIZE 1
#define CSR_ADC_SPI_LOOPBACK_MODE_OFFSET 0
#define CSR_ADC_SPI_LOOPBACK_MODE_SIZE 1
#define CSR_ADC_TRIGGER_CONTROL_ADDR (CSR_BASE + 0x20L)
...
#define CSR_ADC_HAD1511_CONTROL_ADDR (CSR_BASE + 0x24L)
...
#define CSR_ADC_HAD1511_STATUS_ADDR (CSR_BASE + 0x28L)
#define CSR_ADC_HAD1511_STATUS_SIZE 1
#define CSR_ADC_HAD1511_DOWNSAMPLING_ADDR (CSR_BASE + 0x2cL)
#define CSR_ADC_HAD1511_DOWNSAMPLING_SIZE 1
#define CSR_ADC_HAD1511_RANGE_ADDR (CSR_BASE + 0x30L)
...
#define CSR_ADC_HAD1511_BITSLIP_COUNT_ADDR (CSR_BASE + 0x34L)
#define CSR_ADC_HAD1511_BITSLIP_COUNT_SIZE 1
#define CSR_ADC_HAD1511_SAMPLE_COUNT_ADDR (CSR_BASE + 0x38L)
...
#define CSR_FRONTEND_CONTROL_LDO_EN_OFFSET 0
#define CSR_FRONTEND_CONTROL_LDO_EN_SIZE 1
...
#define CSR_FRONTEND_STATUS_ADDR (CSR_BASE + 0x2004L)
#define CSR_FRONTEND_STATUS_SIZE 1
#define CSR_FRONTEND_STATUS_LDO_PWR_GOOD_OFFSET 0
#define CSR_FRONTEND_STATUS_LDO_PWR_GOOD_SIZE 1
#define CSR_FRONTEND_SPI_CONTROL_ADDR (CSR_BASE + 0x2008L)
...
#define CSR_FRONTEND_SPI_STATUS_ADDR (CSR_BASE + 0x200cL)
...
#define CSR_FRONTEND_SPI_MOSI_ADDR (CSR_BASE + 0x2010L)
#define CSR_FRONTEND_SPI_MOSI_SIZE 1
#define CSR_FRONTEND_SPI_MISO_ADDR (CSR_BASE + 0x2014L)
#define CSR_FRONTEND_SPI_MISO_SIZE 1
#define CSR_FRONTEND_SPI_CS_ADDR (CSR_BASE + 0x2018L)
#define CSR_FRONTEND_SPI_CS_SIZE 1
#define CSR_FRONTEND_SPI_CS_SEL_OFFSET 0
#define CSR_FRONTEND_SPI_CS_SEL_SIZE 4
#define CSR_FRONTEND_SPI_CS_MODE_OFFSET 16
#define CSR_FRONTEND_SPI_CS_MODE_SIZE 1
#define CSR_FRONTEND_SPI_LOOPBACK_ADDR (CSR_BASE + 0x201cL)
